...
class LoginScreenRedesigned extends ConsumerStatefulWidget {
  const LoginScreenRedesigned({super.key});

  @override
  ConsumerState<LoginScreenRedesigned> createState() =>
      _LoginScreenRedesignedState();
}

class _LoginScreenRedesignedState extends ConsumerState<LoginScreenRedesigned>
